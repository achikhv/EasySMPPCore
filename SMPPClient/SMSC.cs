...
namespace EasySMPP
{
    ...
    public class SMSC
    {
        ...
        private byte? sourceTon = null;
        private byte? sourceNpi = null;
        private byte? addrTon = null;
        private byte? addrNpi = null;
        private string addressRange = "";
        private BindModes bindMode = BindModes.Transceiver;
        ...
        public SMSC(string description, string host, int port, string systemId, string password, string systemType, int sequenceNumber)
            : this(description, host, port, systemId, password, systemType, sequenceNumber, BindModes.Transceiver)
        {
        }
        ...
        public BindModes BindMode
        {
            get { return bindMode; } // get
            set { bindMode = value; } // set
        }
